...
#11.2.3  变量设置及数据处理
data=pd.read_csv('C:/Users/Administrator/.spyder-py3/数据11.1.csv')
...
model.explained_variance_#计算提取的各个主成分的特征值
model.explained_variance_ratio_#计算各主成分的方差贡献率
...
model.components_#计算主成分载荷，观察每个变量对于主成分的影响
